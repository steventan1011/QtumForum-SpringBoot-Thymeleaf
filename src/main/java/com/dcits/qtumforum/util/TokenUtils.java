package com.dcits.qtumforum.util;
...
public class TokenUtils {
    //private static final String SECRET = "com.dcits.qtumforum.";
    ...
    public static ResultDTO verifyToken(String token) throws Exception {
        ...
        JWTVerifier jwtVerifier = JWT.require(Algorithm.HMAC256(SECRET)).withIssuer("QtumForumUser").build();
        try {
